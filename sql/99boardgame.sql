...
DROP TABLE IF EXISTS BoardGameGeekTop300;
CREATE TABLE 'BoardGameGeekTop100' ('GeekRank' int NOT NULL AUTO_INCREMENT, 'GameName' varchar(255) CHARACTER SET utf8 DEFAULT NULL, 'AvgRaiting' double NOT NULL, 'CollectionList' varchar(255) CHARACTER SET utf8 DEFAULT NULL)
INSERT INTO BoardGameGeekTop100 ('GeekRank', 'GameName', 'AvgRaiting', 'CollectionList') VALUES
                                                                                                                                   (1, 'Brass Birmingham', 8.59, '보유'),
