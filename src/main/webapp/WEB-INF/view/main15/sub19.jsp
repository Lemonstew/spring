...
<c:set var="food" value="pizza" scope="request"/>
<c:set var="food" value="burger" scope="session"/>
<c:set var="food" value="dongatsu" scope="application"/>
...
<c:import url="/WEB-INF/view/main15/sub15.jsp" var="sub19output"/>
