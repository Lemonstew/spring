...
<%-- request 영역 : 하나의 request 를 사용하는 곳에서 공유하는 영역 --%>
<c:set var="model" value="제네시스" scope="request"/>
<p>${model}</p>

<%-- session 영역 : 하나의 브라우저에서 오는 여러 request 가 공유하는 영역--%>
...
<%-- 17 번에서 못 쓰는 건 페이지 영역 말고 다 쓸 수 있다--%>
</body>
</html>
