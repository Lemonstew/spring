...
public class ApiController7 {
    ...
    public ResponseEntity sub10() {
        ResponseEntity response = ResponseEntity.status(202).build();
        return response;
    }

    @GetMapping("sub11")
    public ResponseEntity sub11() {
        ResponseEntity response = ResponseEntity.status(403).build();
        return response;
    }
    ...
    public ResponseEntity<Object> sub14() {
        ...
        if (good) {
            ...
            ResponseEntity response = ResponseEntity.status(404).body(Map.of("name", "son", "age", 30));
            return response;
        }
    }
}
